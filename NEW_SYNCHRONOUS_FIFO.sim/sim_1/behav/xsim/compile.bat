...
REM
REM Generated by Vivado on Fri Feb 13 20:07:46 +0530 2026
...
echo "xvlog --incr --relax -prj fif0_tb_vlog.prj"
call xvlog  --incr --relax -prj fif0_tb_vlog.prj -log xvlog.log
